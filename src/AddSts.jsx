            ...
            <div className='bg-dark text-light d-flex flex-column align-items-center pb-5'>
                ...
                <form onSubmit={handleSubmit} className='p-5 d-flex flex-column align-items-center'>
                    <div className="mb-3 px-5 d-flex gap-3">
                        <div>   
                            <label htmlFor="inputPC" className="form-label">Player Casa</label>
                            <input type="text" required onChange={addPlayerC} className="form-control" id="inputPC" aria-describedby="Player Casa"/>
                        </div>
                        <div>   
                            <label htmlFor="inputPF" className="form-label">Player Fora</label>
                    ...
                    <div className="mb-3 px-5 d-flex gap-3">
                        <div>   
                            <label htmlFor="inputposseC" className="form-label">Posse Casa</label>
                            <input type="number" required onChange={addPosseC} className="form-control" id="inputposseC" aria-describedby="Posse de bola"/>
                        </div>
                        <div>   
                            <label htmlFor="inputposseF" className="form-label">Posse Fora</label>
                    ...
                    <div className="mb-3 px-5 d-flex gap-3">
                        <div>   
                            <label htmlFor="inputChutesC" className="form-label">Chutes ao Gol Casa</label>
                        ...
                        <div>   
                            <label htmlFor="inputChutesF" className="form-label">Chutes ao Gol Fora</label>
                    ...
                    <div className="mb-3 px-5 d-flex gap-3">
                        <div>   
                            <label htmlFor="inputGC" className="form-label">Gols Casa</label>
                            <input type="number" required onChange={addGolC} className="form-control" id="inputGC" aria-describedby="Gols Casa"/>
                        </div>
                        <div>   
                            <label htmlFor="inputGF" className="form-label">Gols Fora</label>
